...
```bash
wget -O ${WSROOT}/ros2_ws/src/protolink_drivers_simple/src/simple_pub_sub.cpp https://raw.githubusercontent.com/OUXT-Polaris/protolink_drivers_example/refs/heads/main/protolink_drivers_example/simple_pub_sub/src/simple_pub_sub.cpp
```
...
Run pubsub node.
```bash
ros2 run protolink_drivers_simple simple_pubsub
```
